...
RegisterNetEvent('hospital:server:ambulanceAlert', function(text)
    ...
    for _, v in pairs(players) do
        if v.PlayerData.job.grade.name == 'Medic' then
...
RegisterNetEvent('hospital:server:AddDoctor', function(job)
	if job == 'team' and PlayerJob.grade.name == 'Medic' then
		local src = source
...
QBCore.Commands.Add('test', Lang:t("command.job.help"), {}, false, function(source)
