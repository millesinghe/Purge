            ...
            items = {
                {
                    ...
                    icon = 'bed-pulse',
                    type = 'client',
                    event = 'qb-mechanicjob:build:hospital',
                    shouldClose = true
                },
                {
                    id = 'buildgarage',
                    ...
                    icon = 'campground',
                    type = 'client',
                    event = 'qb-mechanicjob:build:garage',
                    shouldClose = true
                },
                {
                    id = 'buildcrafttable',
                    ...
                    icon = 'campground',
                    type = 'client',
                    event = 'qb-mechanicjob:build:crafttable',
                    shouldClose = true
                },
                -- {
                --     id = 'buildguardpost',
                ...
                --     icon = 'campground',
                --     type = 'client',
                --     event = 'qb-mechanicjob:build:guardpost',
                --     shouldClose = true
                -- },
                {
                    id = 'buildammo',
                    ...
                    icon = 'campground',
                    type = 'client',
                    event = 'qb-mechanicjob:build:ammo',
                    shouldClose = true
                },
                {
                    id = 'buildweapon',
                    ...
                    icon = 'campground',
                    type = 'client',
                    event = 'qb-mechanicjob:build:weapon',
                    shouldClose = true
                }
                ,{
                    id = 'advanceeng',
                    ...
                    items = {
                        {
                            ...
                            icon = 'campground',
                            type = 'client',
                            event = 'qb-mechanicjob:build:radar',
                            shouldClose = true
                        },
                        {
                            id = 'buildradar',
                            title = 'Ladder Structure',
                            icon = 'campground',
                            type = 'client',
                            event = 'qb-mechanicjob:build:ladder',
                            shouldClose = true
                        },
                        {
                            id = 'buildrecycle',
                            ...
                            icon = 'campground',
                            type = 'client',
                            event = 'qb-mechanicjob:build:recycle',
                            shouldClose = true
                        },
                    }        
                }
