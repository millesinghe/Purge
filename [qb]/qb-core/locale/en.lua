local Translations = {
    error = {
        ...
        not_Leader = 'You are not a Leader',
    ...
    info = {
        ...
        job_info = '%{value} of the Team',
        gang_info = 'You are in the team : %{value}',
    ...
    command = {
        ...
        playermanage = {
            setrole = {
                help = 'Set the role for the player (Leader Only)',
                params = {
                    id = { name = 'id', help = 'Player ID' },
                    grade = { name = 'role', help = 'Assigning Role' },
                },
            },
            setteam = {
                help = 'Set the team (Leader Only)',
                params = {
                    tname = { name = 'name', help = 'Team Name' },
                },
            },
            join = {
                help = 'Add a player to the team (Leader Only)',
                params = {
                    id = { name = 'id', help = 'Player ID' },
                },
            },
            kick = {
                help = 'Remove a player from the team (Leader Only)',
                params = {
                    id = { name = 'id', help = 'Player ID' },
                },
            },    
